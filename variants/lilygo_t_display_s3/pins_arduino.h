...
// ⚠ SecureGen custom variant: BUTTON_1/BUTTON_2 swapped vs original
// Original variant: BUTTON_1=0(GPIO0), BUTTON_2=14(IO14)
// SecureGen needs: BUTTON_1=14(IO14) → change value, BUTTON_2=0(GPIO0) → confirm
static const uint8_t BUTTON_1 = 14;   // IO14 — change value (top function)
static const uint8_t BUTTON_2 = 0;    // GPIO0 — confirm/select (bottom function)
